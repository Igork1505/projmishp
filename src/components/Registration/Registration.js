            ...
            <div className="container">
                ...
                <div className="row">
                    ...
                    <div className='div3 col-sm-3'>
                        <div>
                            <ImageUpload avatar={this.state.avatar} closeavatar={this.ChangeAvatar} submitForm={this.ChangeSubmit}/>
                            <button onClick={this.ChangeAvatar}><img ref='avatar' src={noavatar} alt="avatar" width="150"/></button>
